...
| `ai-code-claimed` | Bot is working on it (replaces `ai-code`) |
| `ai-code-done` | PR opened successfully (replaces `ai-code-claimed`) |
| `ai-code-failed` | Bot could not complete the issue (replaces `ai-code-claimed`) |

To retry a failed issue, remove `ai-code-failed` and add `ai-code` again.
